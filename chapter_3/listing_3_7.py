...
while True:
    ...
    for event, _ in events:
        ...
        # если событие произошло с сервным сокетом, значит произошла попытка подключения клиента
        if event_socket == server_socket:
            ...
            # если событие произошло не с серверным сокетом, то получить данные от клиента и отправить их обранто
