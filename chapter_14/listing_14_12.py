...
class EventLoop:
    ...
    # зарегистрировать в селекторе сокет для события чтения
    ...
    # выполнить главную сопрограмму, пока она не завершится и на каждой итерации выполнять готовые к работе задачи
    def run(self, coro):
