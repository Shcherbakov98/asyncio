...
def generate_customer(customer_id: int) -> Customer:  # сгенерировать случайного покупателя
    all_products = [
        Product('Пиво', 2),
        Product('Бананы', 5),
        Product('Колбаса', 0.2),
...
async def customer_generator(queue: Queue):  # генерировать несколько случайных покупателей в секунду
    customer_count = 0
    while True:
